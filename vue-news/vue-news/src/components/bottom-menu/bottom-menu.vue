  ...
  methods:{
    ...
    goBack(){
      if(this.$store.state.goType == 1){
        ...
        router.push({name:'themDeatil',params:{id:this.$store.currentThemeId}})
      }
    ...
    thumbUp(){
      ...
      let popularity = this.$store.state.popularity;
      if(this.thumb){
        popularity = popularity + 1;
        this.$store.dispatch('changePopularity', popularity);
      }else{
        popularity = popularity - 1;
        this.$store.dispatch('changePopularity', popularity);
      }
